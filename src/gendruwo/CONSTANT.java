...
public class CONSTANT {
    ...
    public static final float DECAY_POP_RATE = 0.008f;    /*0.8%*/
    ...
    public static final float COVER_COUPLE_MIN = 0.48f;     /*48%*/
    public static final float COVER_COUPLE_MAX = 0.84f;     /*84%*/
